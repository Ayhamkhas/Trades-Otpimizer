...
int GENERATIONS = 150;             // Number of generations to run
...
int MIN_SHORT_MA = 5;              // Minimum short moving average period
int MAX_SHORT_MA = 50;             // Maximum short moving average period
int MIN_LONG_MA = 51;              // Minimum long moving average period
int MAX_LONG_MA = 120;              // Maximum long moving average period
